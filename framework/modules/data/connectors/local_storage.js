...
M.DataConnectorLocalStorage = M.DataConnector.extend({
     ...
     */
    find: function( obj ) {
        var collection = M.Collection.create(obj);
            ...
            for(var i = 0; i < length; i++) {
                ...
                if(regexResult) {
                    try {
                        ...
                        M.Logger.error('Error while parsing record data from local storage: ' + e, M.CONST.LOGGER.TAG_FRAMEWORK_DATA);
                    }
        ...
        if (this._checkData(obj, data)) {
            ...
            _.each(records, function(rec) {
                try {
                    ...
                    M.Logger.error('Error while saving record to local storage: ' + e, M.CONST.LOGGER.TAG_FRAMEWORK_DATA);
                }
            });
        }
    },
        ...
        if(this._checkData(obj, data)) {
            ...
            _.each(records, function(rec) {
                try {
                    ...
                    M.Logger.error('Error while removing record from local storage: ' + e, M.CONST.LOGGER.TAG_FRAMEWORK_DATA);
                }
            });
        }
    },
